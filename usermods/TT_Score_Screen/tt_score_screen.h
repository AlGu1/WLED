...
#define WIFI_SSID "VodafoneMobileWIFI-968425"
#define WIFI_PASSWORD "6682348863"

// Insert Firebase project API Key
#define API_KEY "AIzaSyB-j0nIsVHgh7-Lq4AmP01BAZDEo-2WXWs"

// Insert RTDB URLefine the RTDB URL */
#define DATABASE_URL "https://tt-score-21d90-default-rtdb.europe-west1.firebasedatabase.app/" 
  ...
  public:
    ...
    void writeHomeCount() {
      if (Firebase.ready()){
        ...
        if (Firebase.RTDB.setInt(&fbdo, "HomeCount", homeCount)){
    ...
    void writeGuestCount() {
      if (Firebase.ready()){
        // Write an Int number on the database path test/int
        if (Firebase.RTDB.setInt(&fbdo, "GuestCount", guestCount)){
          Serial.println("PASSED");
          Serial.println("PATH: " + fbdo.dataPath());
          Serial.println("TYPE: " + fbdo.dataType());
        }
